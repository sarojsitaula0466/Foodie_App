...
import { View, Text, StyleSheet, SafeAreaView, TouchableOpacity, Image, ScrollView, Switch, TouchableOpacityBase } from 'react-native';
        ...
        <View style={styles.container}>
            <ScrollView contentInsetAdjustmentBehavior="automatic">
                ...
                <View style={styles.Image}>
                    <Image source={require('../assets/images/cheeseburger.png')}
                    style={styles.burger}
                    />
                </View>
                {/*Add on */}
            ...
            {/*Add to cart */}
                <TouchableOpacity onPress={() => alert("Your order has been added to your cart!")}>
